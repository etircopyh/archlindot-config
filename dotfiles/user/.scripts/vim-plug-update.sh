...
if [ ! -f ~/.local/share/nvim/site/autoload/plug.vim ] || [ "$(/usr/bin/diff ~/.local/share/nvim/site/autoload/plug.vim <(curl -fsSL https://raw.githubusercontent.com/junegunn/vim-plug/master/plug.vim) >&1)" ]; then
