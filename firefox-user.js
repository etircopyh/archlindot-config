...
// Control TLS versions (Firefox telemetry (April 2019) shows only 0.5% of TLS web traffic uses 1.0 or 1.1)
...
user_pref("media.eme.enabled", true); // DRM-controlled content playback
